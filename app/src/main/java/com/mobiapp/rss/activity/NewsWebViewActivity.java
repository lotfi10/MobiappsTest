...
/**
 * Created by latitude on 08/11/2017.
 */
...
public class NewsWebViewActivity extends AppCompatActivity{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            progressBar = (ProgressBar) findViewById(R.id.activity_news_webview_progressbar);

            int index = getIntent().getIntExtra(KEY_INDEX, -1);
            if (index != -1) {
                updateNewsDetails(index);
            } else {
                Toast.makeText(NewsWebViewActivity.this, "Sorry incorrect index passed", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void updateNewsDetails(int index) {
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(NewsWebViewActivity.this, "Error in loading webpage", Toast.LENGTH_SHORT).show();
                }
            });
